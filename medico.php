<?php
    ...
    */
    ...
    //VERIFICAR SI UN USUARIO MÉDICO INICIO SESIÓN
    ...
    if( !($resultado_unico['ID_PERMISO'] == "MED")){
      header('Location:formulario.php');
    }

    //var_dump($resultado_permiso['DNI']);

    //BUSCAR EL DNI DEL USUARIO ACTUAL EN LA TABLA MÉDICO PARA OBTENER SUS DATOS PERSONALES Y PERMISOS
    $sql_dni = 'SELECT * FROM medico WHERE dni=?';
    ...
    */
    ...
    $sql_turno = 'SELECT * FROM vw_turno WHERE DNI_MEDICO=? AND FECHA >= ? ORDER BY FECHA, HORARIO ASC';
      ...
      <div class="row">
        ...
        <div class="col-md-6">
                ...
                <div class="alert alert-primary" role="alert">
                  ...
                  <a href="medico.php?campo=telefono_celular" class="float-right">
                ...
                <div class="alert alert-primary" role="alert">
                  ...
                  <a href="medico.php?campo=telefono_fijo" class="float-right">
                    <i class="fas fa-pencil-alt"></i>
                  </a>
                </div>
              ...
              <!-- EDITAR NÚMERO DE TELÉFONO MÓVIL O FIJO -->
                <?php if($_GET): ?>
                  ...
                  <?php if($_GET['campo'] == "telefono_celular"): ?>  
                    ...
                    <form method="POST" action="editar_celular_med.php">
                  ...
                  <?php if($_GET['campo'] == "telefono_fijo"): ?>
                    ...
                    <form method="POST" action="editar_telefono_fijo_med.php">
