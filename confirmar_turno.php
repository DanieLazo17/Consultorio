<?php
    ...
    */
    ...
    //NO PERMITIR ACCESO AL ARCHIVO LOCAL CONFIRMAR TURNO A TRAVÉS DE LA URL
    if( !isset($_GET['id']) ){
    ...
    <div class="container mt-3">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <?php
                    $numero_turno = $_GET['id'];

                    $estado = "Confirmado";

                    //Confirmar turno
                    $buscar_turno = 'UPDATE turno SET estado = ? WHERE id_turno = ?';
                    $sentencia_editar = $pdo->prepare($buscar_turno);

                    if( $sentencia_editar->execute(array($estado, $numero_turno)) ){
                        echo 'Turno confirmado<br>';
                        echo '<br><a href="ver_turnos.php">Volver a próximos turnos</a>';
                    }
                    else{
                        echo 'Error<br>';                        }
