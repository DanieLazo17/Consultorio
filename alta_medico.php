<?php
    ...
    */
    ...
    if(!isset($_POST['dni']) && !isset($_POST['permiso']) && !isset($_POST['nombre']) && !isset($_POST['direccion']) && !isset($_POST['localidad']) && !isset($_POST['telefono_celular']) && !isset($_POST['telefono_fijo'])){
                ...
                <?php
                    ...
                    */
                    ...
                    if( $sentencia_guardar->execute(array($dni_nuevo, $permiso)) ){
                        echo 'Número de documento de médico agregado<br>';
                    }
                    else{
                        echo 'Error<br>';
                    }
                    ...
                    */
                    ...
                    //AGREGAR A LA TABLA MEDICO DATOS CORRESPONDIENTES
                    $sql_grabar = 'INSERT INTO medico VALUES (?,?,?,?,?,?)';
                    $sentencia_grabar = $pdo->prepare($sql_grabar);

                    if( $sentencia_grabar->execute(array($dni_nuevo, $nombre, $direccion, $localidad, $telefono_celular, $telefono_fijo)) ){
                        /*
                            Cerramos conexión de base de datos y sentencia
                        */
                        $sentencia_grabar = null;

                        echo 'Datos de médico almacenados<br>';
                        echo '<br><a href="administracion.php">Volver al menú</a>';
                    }
                    else{
                        echo 'Error<br>';
